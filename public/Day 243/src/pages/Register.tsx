    ...
    <div className="flex min-h-[calc(100vh-4rem)] items-center justify-center px-4 py-12">
      <div className="w-full max-w-md rounded-2xl border border-border bg-card p-8 shadow-card">
        <div className="text-center">
          ...
          <p className="mt-1 text-sm text-muted-foreground">Join thousands of freelancers and clients</p>
        </div>
        ...
        <form className="mt-6 space-y-4" onSubmit={(e) => e.preventDefault()}>
          ...
          <Link to={role === "client" ? "/client/dashboard" : "/freelancer/dashboard"}>
            <Button className="mt-2 w-full rounded-xl" size="lg">Create Account</Button>
          </Link>
        </form>
